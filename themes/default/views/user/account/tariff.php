...
$(function ()
{
	$('#days_select').bind('change',function(){
			...
			{
				case 1:
					amount = parseInt(<?=$data[Tariffs::PRO]['price']?>);
				break
				case 3:
					amount = parseInt(<?=$data[Tariffs::PRO]['price3']?>);
				break
				case 6:
					amount = parseInt(<?=$data[Tariffs::PRO]['price6']?>);
				break
				case 12:
					amount = parseInt(<?=$data[Tariffs::PRO]['price12']?>);
				break
			}
