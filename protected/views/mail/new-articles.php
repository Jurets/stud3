...
<title>Уведомления о новых статьях</title>
</head>
				...
				<table width="630" border="0" cellspacing="0" cellpadding="0">
					...
					<td bgcolor="#FFFFFF" valign="top" style="border-top: none; border-right: none; border-bottom: none; border-left: none; padding-bottom: 20px;">
						<table border="0" cellspacing="0" cellpadding="0" >
							...
							<!-- colored title text goes here -->Новые статьи
							</td>
							</tr>
							<tr>
...
<? foreach($projects as $row): ?>
					<!-- START module / two diff size column text right image left NEWS 1 -->
					<tr>
						...
						<table width="630" border="0" cellspacing="0" cellpadding="0">
							...
							<td width="196" align="left" valign="top" >
								<table width="196" border="0" cellspacing="0" cellpadding="0" >
									...
									<td align="left" valign="top" style="padding-bottom: 10px; ">
										<table width="196" border="0" cellspacing="0" cellpadding="0" >
											<tr>
											<td bgcolor="#444444" align="left" valign="middle" style="font-family: Arial,Helvetica,sans-serif; font-size: 11px; color: #B0B0B0; padding-top: 6px; padding-bottom: 6px; padding-left: 0px; padding-right: 10px; ">
											<!-- featuring text--><ul style="list-style:none;"><? foreach($row->gettags() as $tag): ?><li><a href="<?=Yii::app()->params['site']?>/blogs/?tag=<?=$tag?>" style="color:#999;"><?=$tag?></a></li> <? endforeach; ?></ul>
											</td>
											</tr>
										</table>
									</td>
									...
									<td align="left" valign="top" style="font-family: Arial,Helvetica,sans-serif; font-size: 18px; line-height: 22px; color: #54A9D0; padding-bottom: 20px;">
										<!-- image goes here --><img src="<?=Yii::app()->getModule('articles')->articlesDir?><?=$row->preview?>" alt="196px image" border="no" style="margin: 0px; padding: 0px; display: block;"/>
									</td>
									</tr>
								</table>
							</td>
							...
							<td width="414" align="left" valign="top" >
								<table width="414" border="0" cellspacing="0" cellpadding="0" >
									<tr>
									<td align="left" valign="top" style="font-family: Arial,Helvetica,sans-serif; font-size: 18px; line-height: 22px; color: #54A9D0; padding-bottom: 10px;">
									<!-- title goes here --><a href="<?=Yii::app()->params['site']?>/articles/<?=$row->id?>.html" style="color: #54A9D0;"><?=$row->title?></a>
									</td>
									</tr>
									<tr>
									...
									<!-- text goes here --><?=$row->short_text_v?>
									</td>
									</tr>
									<tr>
									<td align="left" valign="top" style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; line-height: 20px; color: #888888; padding-bottom: 20px;">
									<!-- button goes here --><a href="" title="" target="_blank"><img src="<?=Yii::app()->params['site']?>/images/email/butt-small-view.jpg" alt="view" border="no" style="margin: 0px; padding: 0px;"/></a>
									</td>
									</tr>
								</table>
							</td>
