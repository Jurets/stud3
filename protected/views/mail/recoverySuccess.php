...
<p>Рекомендуем зайти на сайт и сменить пароль - <a target="_blank" href="<?=Yii::app()->params['site']?>/account/changepassword"><?=Yii::app()->params['site']?>/account/changepassword</a></p>
<hr/>
<p>С уважением, <br/>
