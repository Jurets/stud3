<?php
class RegistrationForm2 extends CFormModel
{
    public $username;
    public $email;
    public $password;
	...
	*/
    public function rules()
    {
        ...
        return array(
            ...
            array('username, password, password2, email, name, surname, gender', 'required'),// обязательные поля
            ...
            //array('password, password2', 'compare', 'compareAttribute' => 'password2')
        );
    }
