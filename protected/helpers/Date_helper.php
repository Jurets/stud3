...
class Date_helper 
{
	public static function convertToUnix($date, $split = '/')
    {
	...
	public static function date_smart($date_input, $datestr = '%d.%m.%Y %G:%i', $time = true)
	{
		if( $date_input == '' )
			$date_input = time();
	...
	public static function date_await($date_input)//Сколько времени до событиая
	{
    ...
    //Возраст 
	public static function date_age($day, $month, $year)
	{
