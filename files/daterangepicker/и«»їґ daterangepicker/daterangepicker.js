...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<div style="float: left; padding-left: 11px;  display:none">' +
                      '<label for="daterangepicker_end">' + this.locale.toLabel + '</label>' +
                      '<input class="input-mini" type="text" name="daterangepicker_end" value="" />' +
                    '</div>' +
                    '<a class="btn btn-small btn-success">' + this.locale.applyLabel + '</a>' +
                  '</div>' +
                '</div>' +
              '</div>';

        //the date range picker
        this.container = $(DRPTemplate).appendTo('#tender');
        ...
        this.container.find('.ranges').on('click', 'a', $.proxy(this.clickApply, this));
    ...
    DateRangePicker.prototype = {
        ...
        updateView: function () {
            ...
            if (this.startDate.equals(this.endDate) || this.startDate.isBefore(this.endDate)) {
                this.container.find('a').removeAttr('disabled');
            } else {
                this.container.find('a').attr('disabled', 'disabled');
            }
        },
